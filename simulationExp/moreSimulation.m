...
parfor i = 1:nsim
    [A, tau, ~] = sbm(rho, B, n);
    occlusionErr = occlusion(p, A, tau, 2, 2);
    occlusionErrSparsity3 = occlusion(p, A, tau, 2, 3);
    occlusionErrSparsity4 = occlusion(p, A, tau, 2, 4);
    occlusionErrSparsity5 = occlusion(p, A, tau, 2, 5);
...
figure; plot(d_vec, errorMat(:,1), 'bo-', d_vec, errorMat(:,2), 'kx-', d_vec, errorMat(:,3), 'r^-' ,'LineWidth', 2, 'MarkerSize', 6);
set(gca,'FontSize',18)
